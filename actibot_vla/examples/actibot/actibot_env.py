...
from . import robotutils as _robotutils
from collections import deque



class ActibotEnvironment(_environment.Environment):
    """Actibot 实机环境（ROS2）。
    """
    ...
    def __init__(
        ...
        *,
        ...
        self._bridge = _robotutils.ActibotROS2Bridge(
            _robotutils.ActibotROS2Config(
        ...
        self.prompt = prompt
        self._started = False
        self.effort_deque = deque(maxlen=5)  # 固定长度 5
        self.velocity_deque = deque(maxlen=5)  # 固定长度 5
    ...
    def get_observation(self) -> dict:
        ...
        velocity = node.get_velocity()  # 获取速度信息  
